...
function renderShj(){
 ...
 if(!state.computed.length){$('shjTable').innerHTML='<tbody><tr><td class="empty">Upload data first.</td></tr></tbody>';['shjKpiUrgent','shjKpiTransfer','shjKpiBavaria','shjKpiPurchase','shjKpiQty'].forEach(id=>$(id).textContent='0');$('shjResults').textContent='0 items';updateShjSelectionButtons();return;}
